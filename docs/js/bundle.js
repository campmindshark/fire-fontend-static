...
var FireController = function () {
  function FireController(ip) {
    _classCallCheck(this, FireController);

    this.beaglebone_ip = ip;
  }

  _createClass(FireController, [{
    key: 'loadConfigFromBeaglebone',
    value: function loadConfigFromBeaglebone() {
      var self = this;
      return $.get({
...
var FireController = __webpack_require__(1);
var signfireFireController = new FireController(__webpack_require__(6).sign_ip);
var eyefireFireController = new FireController(__webpack_require__(6).eyefire_ip);
...
var _apiWrapper = __webpack_require__(1);
...
window.$ = window.jQuery = _jquery2.default;
// import './src/script/api/api-wrapper.js'
